...
void makePlots2Lepton() {
  ...
  config.addBackgroundSample("Zeeb", "Z+b", kAzure + 1);
  config.addBackgroundSample("Zeec", "Z+c", kAzure - 4);
  config.addBackgroundSample("Zeel", "Z+l", kAzure - 9);
  config.addBackgroundSample("Zmumub", "Z+b", kAzure + 1);
  config.addBackgroundSample("Zmumuc", "Z+c", kAzure - 4);
  config.addBackgroundSample("Zmumul", "Z+l", kAzure - 9);
